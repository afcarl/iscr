...
from iscr.searchengine import Indexer
...
if __name__ == "__main__":
	...
	parser.add_argument('-o', '--out_dir', type=str, default='./iscr/searchengine/collections/PTV.dnn.onebest.jieba',
						help='Save indices to index directory')
	args = parser.parse_args()

	indexer = Indexer()
	indexer.run_indexing(transcript_dir=args.transcript_dir, query_file=args.query_file, out_dir=args.out_dir)
